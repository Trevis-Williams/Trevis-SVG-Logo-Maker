import { createSVGWindow, config, setFontDir } from './main-module.js'
const fs = require('fs')
// const a = require('.')
...
const main = async () => {
  ...
  SVG('<symbol overflow="visible" id="glyph1-0"><path style="stroke:none;" d=""/></symbol>').addTo(document.documentElement)
